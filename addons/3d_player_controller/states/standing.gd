...
const ANIMATION_STANDING_KICKING_LOW_LEFT := "Kicking_Low_Left"
const ANIMATION_STANDING_KICKING_LOW_RIGHT := "Kicking_Low_Right"
const ANIMATION_STANDING_PUNCHING_HIGH_LEFT := "Punching_High_Left"
const ANIMATION_STANDING_PUNCHING_HIGH_RIGHT := "Punching_High_Right"
const ANIMATION_STANDING_PUNCHING_LOW_LEFT := "Punching_Low_Left"
const ANIMATION_STANDING_PUNCHING_LOW_RIGHT := "Punching_Low_Right"
const ANIMATION_STANDING_USING := "Button_Pushing"
